        ...
        {step === "id_lookup" ? (
          ...
          >
            <p className="font-dhivehi text-2xl text-right text-cyan-800">
              އިންނަމާދޫ ކައުންސިލް ޤުރުއާން މުބާރާތުގައި ބައިވެރިވެފައިވާނަމަ އައިޑީކާޑް ނަންބަރު ޖައްސަވާ ސާރޗް ކުރައްވާ. ބައިވެރިވެފައި ނުވާނަމަ އަލުން ރެޖިސްޓާ ކުރައްވާ.
            </p>
            <div>
