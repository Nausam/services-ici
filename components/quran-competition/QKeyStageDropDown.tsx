...
const QKeyStageDropDown = ({
  ...
  const isGradeVariant = variant === "grade";
  const gradeOptions = [
    "އެލްކޭޖީ",
    "ޔޫކޭޖީ",
    ...Array.from({ length: 10 }, (_, index) => `ގްރޭޑް ${index + 1}`),
  ];
    ...
    >
      ...
      >
        <SelectValue
          ...
          placeholder={isGradeVariant ? " ގްރޭޑް " : " އުމުރުފުރާ "}
        />
      </SelectTrigger>
      <SelectContent
        dir="rtl"
